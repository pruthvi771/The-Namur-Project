...
class AppConfig {
 ...
 //ecom.raylancer.co
  static const DOMAIN_PATH = "demo.activeitzone.com/ecommerce_flutter_demo"; //localhost
 ...
 // static const String PUBLIC_FOLDER ="public";
  ...
  static const String BASE_URL =  "https://ecom.raylancer.co/api/v2";//"${RAW_BASE_URL}/${API_ENDPATH}";
