                         ...
                         children: [
                           ...
                           Row(
                             children: [
                               ...
                               Container(child: Text("Onion Seeding",
                                 style: TextStyle(
                                     fontSize: 15,
                                     fontWeight: FontWeight.w400,
                                     fontFamily: "Poppins"),),),
                        ...
                        child: ListView.builder(
                          ...
                          return
                              Padding(
                                ...
                                child: InkWell(
                                  onTap: (){
                                    Navigator.push(context, MaterialPageRoute(builder: (context)=>ManMachine()));
                                  },
                                  child: Column(
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          InkWell(
                            onTap: (){
                              Navigator.push(context, MaterialPageRoute(builder: (context)=> PestControl()));
                            },
                            child: Column(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                          ...
                          InkWell(
                            onTap: (){
                              Navigator.push(context,MaterialPageRoute(builder: (context)=>CultivationTips()));
                            },
                            child: Column(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                ...
                                SizedBox(height: 3),
                                Text(AppLocalizations.of(context)!.cultivation_tips_ucf,
                                  style: TextStyle(fontWeight: FontWeight.w500,
                                      fontFamily: "Poppins"),)
                              ],
                            ),
